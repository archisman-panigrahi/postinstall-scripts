...
sudo apt install ./megasync-xUbuntu_23.10_amd64.deb -y
wget https://mega.nz/linux/repo/xUbuntu_22.04/amd64/dolphin-megasync-xUbuntu_22.04_amd64.deb
sudo apt install ./dolphin-megasync-xUbuntu_22.04_amd64.deb -y
