...
yay -S plasma-desktop  plasma-wayland-session sddm
sudo systemctl enable sddm.service

yay -S okular gwenview partitionmanager kalzium kamoso kdeconnect latte-dock filelight ksysguard 

yay -S inkscape foliate blanket wike vlc firefox chromium telegram-desktop octave jupyter-notebook code freetube-bin geogebra github-desktop-bin globalprotect-openconnect marker kvantum texlive-basic texlive-latexextra texlive-latexrecommended texlive-mathscience texlive-plaingeneric texlive-xetex texstudio pdfarranger libreoffice-fresh micro
